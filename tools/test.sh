...
expect "protected mode is entered"      "SifarOS 2.0.0|a small operating system"
...
expect "uname reports the system"       "SifarOS 2.0.0 i386"
...
expect "release file reads back"        "SifarOS 2.0.0 \(i386\)"
