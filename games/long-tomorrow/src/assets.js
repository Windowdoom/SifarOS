...
const Assets={
  ...
  async loadCredits(){
    ...
    if(window.__CREDITS__){this.credits=window.__CREDITS__;return this.credits;}
    try{const r=await fetch(this.url('CREDITS.json'));this.credits=await r.json();}catch(e){this.credits=[];}
    return this.credits;
  },
