...
/* Validate a user pointer that the kernel is about to write to. */
...
static int32_t sys_opendir(uint32_t path_ptr, uint32_t out_ptr, uint32_t max)
{
    ...
    if (proc_copy_user_string((const char *)(uintptr_t)path_ptr, path, sizeof(path)) < 0)
        return -1;
    if (max > (uint32_t)(SIZE_MAX / sizeof(struct sys_dirent)))
        return -1;
...
static void syscall_handler(struct registers *regs)
{
    ...
    switch (number) {
    case SYS_EXIT: proc_exit((int)arg1); break;
    case SYS_WRITE: result = sys_write(arg1, arg2, arg3); break;
    case SYS_READ: result = sys_read(arg1, arg2, arg3); break;
    case SYS_YIELD: sched_yield(); result = 0; break;
    case SYS_SLEEP: thread_sleep_ms(arg1); result = 0; break;
    case SYS_GETPID: result = proc_current()->pid; break;
    case SYS_UPTIME: result = (int32_t)timer_ms(); break;
    case SYS_FS_WRITE: result = sys_fs_write(arg1, arg2, arg3); break;
    case SYS_FS_READ: result = sys_fs_read(arg1, arg2, arg3); break;
    case SYS_PUTC: console_putc((char)arg1); result = 0; break;
    case SYS_SBRK: result = (int32_t)proc_sbrk((int32_t)arg1); break;
    case SYS_SPAWN: result = sys_spawn(arg1, arg2, arg3); break;
    case SYS_WAIT: {
        int code = 0;
        if (arg2) {
    ...
    case SYS_OPENDIR: result = sys_opendir(arg1, arg2, arg3); break;
    case SYS_STAT: result = sys_stat(arg1, arg2); break;
    case SYS_UNLINK:
    case SYS_MKDIR:
    case SYS_CHDIR: result = sys_path_op(arg1, (int)number); break;
    case SYS_FS_APPEND: result = sys_fs_append(arg1, arg2, arg3); break;
    case SYS_GETCWD: result = sys_getcwd(arg1, arg2); break;
    case SYS_GUI_CREATE: result = sys_gui_create(arg1, arg2, arg3); break;
    case SYS_GUI_INFO: result = sys_gui_info(arg1, arg2); break;
    case SYS_GUI_INVALIDATE:
        result = wm_invalidate(proc_current(), arg1,
                               (int)(int16_t)(arg2 & 0xFFFF),
                               (int)(int16_t)(arg2 >> 16),
                               (int)(arg3 & 0xFFFF), (int)(arg3 >> 16));
        break;
    case SYS_GUI_POLL: result = sys_gui_poll(arg1, arg2); break;
    case SYS_GUI_WAIT: result = sys_gui_wait(arg1, arg2, arg3); break;
    case SYS_GUI_DESTROY: result = wm_destroy_window(proc_current(), arg1); break;
    case SYS_GUI_TITLE: {
        char title[GUI_MAX_TITLE];
    ...
    case SYS_GUI_MOVE: result = wm_move_window(proc_current(), arg1, (int)arg2, (int)arg3); break;
    case SYS_GUI_RESIZE: result = wm_resize_window(proc_current(), arg1, (int)arg2, (int)arg3); break;
    case SYS_GUI_LIST: result = sys_gui_list(arg1, arg2); break;
    case SYS_GUI_ACTIVATE: result = wm_activate(arg1); break;
    case SYS_GUI_MINIMIZE: result = wm_minimize(arg1); break;
    case SYS_GUI_SCREEN: result = sys_gui_screen(arg1); break;
    case SYS_GUI_FLAGS: result = wm_set_flags(proc_current(), arg1, arg2); break;
    case SYS_SYSINFO: result = sys_sysinfo(arg1); break;
    case SYS_PROCLIST: result = sys_proclist(arg1, arg2); break;
    case SYS_KILL: result = proc_kill((int)arg1); break;
    case SYS_LOG: result = sys_log(arg1, arg2); break;
    case SYS_TIME: result = sys_time(arg1); break;
    case SYS_REBOOT: cpu_reboot(); break;
    case SYS_SHUTDOWN: cpu_halt(); break;
    case SYS_FONT: {
